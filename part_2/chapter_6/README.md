...
The `r` radius vakues and `prop`, proportion value can be changed to make variations in our spirograph.
As well as speed, color of the background or the dot etc. The code for Processing:
